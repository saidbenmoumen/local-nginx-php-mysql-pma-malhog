...
<div class="search-title text-xs-left">
    {l s='The result search for ' d='Modules.WBBockSearch'} "{$query|escape:'quotes':'UTF-8'}" <span>({$search_Total|escape:'quotes':'UTF-8'} {l s=' results have been found.' d='Modules.WBBockSearch'})</span>
...
{$num = 0}
    ...
    {else}
    <p class="noresult">{l s='No found any item!' d='Modules.WBBockSearch'}</p>
{/if}
</ul>
{if $search_Total > $limit_item}
<p class="title_showall_text">{l s='Search limited to ' d='Modules.WBBockSearch'} {$limit_item|escape:'quotes':'UTF-8'} {l s='products' d='Modules.WBBockSearch'}</p>
<p class="title_showall">
<a href="#" onclick="Show_All_Search();return false;">
    <span>{l s='show alls' d='Modules.WBBockSearch'}</span>
    </a>
</p>
{/if}
</div>
