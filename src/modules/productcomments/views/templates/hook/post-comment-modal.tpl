  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="float-xs-left">{l s='Write your review' d='Modules.Productcomments.Shop'}</h2>
        ...
        <form id="post-product-comment-form" action="{$post_comment_url nofilter}" method="POST">
          <div class="row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              ...
              {block name='product_description_short'}
                <div class="pcommentdesc" itemprop="description">{$product.description_short nofilter}</div>
              {/block}
            </div>
            <div class="col-md-9 col-sm-9 col-xs-12">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 post-comment-buttons">
              <button type="button" class="btn btn-primary comcancelbtn" data-dismiss="modal" aria-label="{l s='Cancel' d='Modules.Productcomments.Shop'}">
