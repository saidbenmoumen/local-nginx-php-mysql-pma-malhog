	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('.datetimepicker').datetimepicker({
				...
				currentText: "{l s='Now' mod='wbblog'}",
				closeText: "{l s='Done' mod='wbblog'}",
				ampm: false,
				amNames: ['AM', 'A'],
				pmNames: ['PM', 'P'],
				timeFormat: 'hh:mm:ss tt',
				timeSuffix: '',
				timeOnlyTitle: "{l s='Choose Time' js=1 mod='wbblog'}",
				timeText: "{l s='Time' js=1 mod='wbblog'}",
				hourText: "{l s='Hour' js=1 mod='wbblog'}",
				minuteText: "{l s='Minute' js=1 mod='wbblog'}",
			});
