...
class ProductComments extends Module
{
    ...
    public function install($keep = true)
    {
        ...
        if (parent::install() == false ||
            !$this->registerHook('displayProductFooter') || //Product page footer
            ...
            !$this->registerHook('displayProductListReviewspro') || //Display info in checkout column
    ...
    public function getContent()
    {
        ...
        $this->context->controller->addJs($this->_path . '/modules/productcomments/views/js/moderate.js');
