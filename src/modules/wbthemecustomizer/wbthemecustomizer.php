    ...
    private function defineArrays()
    {
        ...
        $this->cssRules = array(
            ...
            'WB_mainColorScheme' => array(
                ...
                //default-theme.css
                array(
                    'selector' => '.product-additional-info .add_to_compare:hover, .product-additional-info .prowish:hover,.pagination .page-list li a,.wb-wishlist-product .cartb:hover, .wb-productscompare-item .cartb:hover,.custom-radio input[type="radio"]:checked + span,.custom-checkbox input[type="checkbox"] + span .checkbox-checked,.scroll-box-arrows i:hover,.cart-c,.view-wb-dropdown-additional.show, .view-wb-dropdown-additional:hover,#search_block_top .btn.button-search,.quickview .arrows .arrow-up:hover, .quickview .arrows .arrow-down:hover,.block-social li a:hover,.btn-primary.focus, .btn-primary:focus, .btn-primary:hover, .btn-primary.active, .btn-primary:active, .open > .btn-primary.dropdown-toggle, .btn-primary.active.focus, .btn-primary.active:focus, .btn-primary.active:hover, .btn-primary:active.focus, .btn-primary:active:focus, .btn-primary:active:hover, .open > .btn-primary.dropdown-toggle.focus, .open > .btn-primary.dropdown-toggle:focus, .open > .btn-primary.dropdown-toggle:hover, .btn-primary.disabled.focus, .btn-primary.disabled:focus, .btn-primary.disabled:hover, .btn-primary:disabled.focus, .btn-primary:disabled:focus, .btn-primary:disabled:hover,.blog_mask .icon:hover',
                    'rule' => 'background'
                ),
                array(
                    'selector' => '.js-terms a,.page-my-account #content .links a:hover i,.facet-title,#wbsearch_data .items-list li .content_price .price,.wb-compare-wishlist-button .wish:hover span, .wb-compare-wishlist-button .wish:focus span, .wb-compare-wishlist-button .wb-compare-button:hover span, .wb-compare-wishlist-button .wb-compare-button:focus span,#blockcart-modal .product-name,.footer-container li a:hover, .fthr .block:hover, .fthr .data a:hover, .foot-payment li i:hover,.star::after,.star.star_on::after,.wb-menu-vertical ul li.level-1:hover > a,.shop-c h4, .cartdet h4',
                    'rule' => 'color'
                ),
                array(
                    'selector' => '.scroll-box-arrows i:hover,.form-control:focus,.blog_mask .icon,.wb-menu-vertical li.level-1 span:hover::after',
                    'rule' => 'border-color'
                ),
                array(
                    'selector' => '.blog_post_content_bottom hr,.thumbnail-container .product-price-and-shipping hr',
                    'rule' => 'border-top-color'
                ),
                array(
                    'selector' => '.view_menu .more-menu,.wb-menu-vertical .menu-dropdown',
                    'rule' => 'border-bottom-color'
                ),
                array(
                    'selector' => '.wb-compare-wishlist-button .wish:hover svg, .wb-compare-wishlist-button .wish:focus svg, .wb-compare-wishlist-button .wb-compare-button:hover svg, .wb-compare-wishlist-button .wb-compare-button:focus svg,#footer_contact .icon svg,.d-search:hover svg, .user-info:hover svg, .blockcart:hover svg',
                    'rule' => 'fill'
                )
            ),
        ...
        // Web-safe Fonts
        $this->websafeFonts = array('Poppins, Helvetica, sans-serif');
    ...
    private function writeCss()
    {
        ...
        foreach ($this->cssRules as $configName => $css) {
            ...
            if (in_array($configName, $this->fontConfig)) {
                ...
                foreach ($css as $line) {
                    $cssCode .= $line['selector'] . '{' . $line['rule'] . ':' . (isset($line['prefix']) ? $line['prefix'] : '') . (isset($line['value']) ? $line['value'] : '"' . $config[$configName] . '", "Helvetica", "Poppins, Helvetica, sans-serif", "sans-serif"') . (isset($line['suffix']) ? $line['suffix'] : '') . ';}';
                }
