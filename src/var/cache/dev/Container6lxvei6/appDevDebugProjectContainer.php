...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'democqrshooksusage.domain.reviewer.command_handler.toggle_is_allowed_to_review_handler' => 'getDemocqrshooksusage_Domain_Reviewer_CommandHandler_ToggleIsAllowedToReviewHandlerService.php',
            'democqrshooksusage.domain.reviewer.command_handler.update_is_allowed_to_review_handler' => 'getDemocqrshooksusage_Domain_Reviewer_CommandHandler_UpdateIsAllowedToReviewHandlerService.php',
            'democqrshooksusage.domain.reviewer.query_handler.get_reviewer_settings_for_form_handler' => 'getDemocqrshooksusage_Domain_Reviewer_QueryHandler_GetReviewerSettingsForFormHandlerService.php',
            'democqrshooksusage.repository.reviewer' => 'getDemocqrshooksusage_Repository_ReviewerService.php',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'mysql', 'port' => '', 'dbname' => 'di-france', 'user' => 'root', 'password' => 'password', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/modules/ps_democqrshooksusage/src/Entity')]), 'DemoCQRSHooksUsage\\Entity');
        ...
        $a->addEntityNamespace('ModulepsDemocqrshooksusage', 'DemoCQRSHooksUsage\\Entity');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4oRDA3KNKOm4nBcAZMQZvzGYL6CyRMahmitDZdTx9uUFkVRmtnjgAJnmQTTjFLHM'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4oRDA3KNKOm4nBcAZMQZvzGYL6CyRMahmitDZdTx9uUFkVRmtnjgAJnmQTTjFLHM');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                47 => ($this->targetDirs[3].'/modules/gamification/translations'),
                ...
                56 => ($this->targetDirs[3].'/modules/ps_categoryproducts/translations'),
                57 => ($this->targetDirs[3].'/modules/ps_viewedproduct/translations'),
                58 => ($this->targetDirs[3].'/modules/wbblocksearch/translations'),
                59 => ($this->targetDirs[3].'/modules/wbcenterbanner/translations'),
                60 => ($this->targetDirs[3].'/modules/wbcompare/translations'),
                61 => ($this->targetDirs[3].'/modules/wbimageslider/translations'),
                62 => ($this->targetDirs[3].'/modules/wbimgbanner/translations'),
                63 => ($this->targetDirs[3].'/modules/wbinstagram/translations'),
                64 => ($this->targetDirs[3].'/modules/wblogoslider/translations'),
                65 => ($this->targetDirs[3].'/modules/wbmegamenu/translations'),
                66 => ($this->targetDirs[3].'/modules/wbstaticblocks/translations'),
                67 => ($this->targetDirs[3].'/modules/wbthemeconfigurator/translations'),
                68 => ($this->targetDirs[3].'/modules/wbthemecustomizer/translations'),
                69 => ($this->targetDirs[3].'/modules/wbcategoryfeaturedproducts/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                75 => 'wbmegamenu',
                76 => 'wbstaticblocks',
                77 => 'wbthemeconfigurator',
                78 => 'wbthemecustomizer',
                79 => 'customfieldcategory',
                80 => 'wbcategoryfeaturedproducts',
                81 => 'ps_democqrshooksusage',
            ],
            ...
            'kernel.secret' => '4oRDA3KNKOm4nBcAZMQZvzGYL6CyRMahmitDZdTx9uUFkVRmtnjgAJnmQTTjFLHM',
            ...
            'prestashop.commands_and_queries' => [
                ...
                337 => 'DemoCQRSHooksUsage\\Domain\\Reviewer\\Command\\ToggleIsAllowedToReviewCommand',
                338 => 'DemoCQRSHooksUsage\\Domain\\Reviewer\\Query\\GetReviewerSettingsForForm',
                339 => 'DemoCQRSHooksUsage\\Domain\\Reviewer\\Command\\UpdateIsAllowedToReviewCommand',
            ],
