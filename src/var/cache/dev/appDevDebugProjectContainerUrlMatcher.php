...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/modules')) {
            ...
            if (0 === strpos($pathinfo, '/modules/demo-cqrs-hook-usage') && preg_match('#^/modules/demo\\-cqrs\\-hook\\-usage/(?P<customerId>\\d+)/toggle\\-is\\-allowed\\-for\\-review$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'ps_democqrshooksusage_toggle_is_allowed_for_review']), array (  '_controller' => 'DemoCQRSHooksUsage\\Controller\\Admin\\CustomerReviewController::toggleIsAllowedForReviewAction',));
                if (!in_array($requestMethod, ['POST'])) {
                    $allow = array_merge($allow, ['POST']);
                    goto not_ps_democqrshooksusage_toggle_is_allowed_for_review;
                }

                return $ret;
            }
            not_ps_democqrshooksusage_toggle_is_allowed_for_review:
