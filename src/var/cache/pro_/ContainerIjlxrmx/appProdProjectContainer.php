    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                59 => ($this->targetDirs[3].'/modules/wbcategoryfeature/translations'),
                60 => ($this->targetDirs[3].'/modules/wbcenterbanner/translations'),
                61 => ($this->targetDirs[3].'/modules/wbcompare/translations'),
                62 => ($this->targetDirs[3].'/modules/wbimageslider/translations'),
                63 => ($this->targetDirs[3].'/modules/wbimgbanner/translations'),
                64 => ($this->targetDirs[3].'/modules/wbinstagram/translations'),
                65 => ($this->targetDirs[3].'/modules/wblogoslider/translations'),
                66 => ($this->targetDirs[3].'/modules/wbmegamenu/translations'),
                67 => ($this->targetDirs[3].'/modules/wbstaticblocks/translations'),
                68 => ($this->targetDirs[3].'/modules/wbthemeconfigurator/translations'),
                69 => ($this->targetDirs[3].'/modules/wbthemecustomizer/translations'),
            ]; break;
